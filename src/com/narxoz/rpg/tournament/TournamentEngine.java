...
public class TournamentEngine {
    ...
    public TournamentResult runTournament() {
        ...
        while (hero.isAlive() && opponent.isAlive() && round < maxRounds) {
            ...
            result.addLine("Round " + round + " - Queued actions:");
            ...
            if (opponent.isAlive()) {
                result.addLine("Opponent attacks with " + opponent.getAttackPower() + " damage!");
                dodge.handle(opponent.getAttackPower(), hero);
            }

            result.addLine("[Round " + round + "] Opponent HP: " + opponent.getHealth() + " | Hero HP: " + hero.getHealth());
        }
